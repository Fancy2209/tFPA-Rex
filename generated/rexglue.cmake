...
# Codegen target - run 'cmake --build . --target tfpa_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(tfpa_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/tfpa_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for tfpa"
    VERBATIM
)
